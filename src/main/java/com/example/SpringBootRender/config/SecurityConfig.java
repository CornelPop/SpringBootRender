package com.example.SpringBootRender.config;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                .authorizeHttpRequests(authConfig -> {
                    ...
                    authConfig.requestMatchers(HttpMethod.GET, "/createUser").hasAnyAuthority("ADMIN");
                    authConfig.requestMatchers(HttpMethod.GET, "/deleteUser").hasAnyAuthority("ADMIN");
                    authConfig.requestMatchers(HttpMethod.GET, "/updateUser").hasAnyAuthority("ADMIN");
                    authConfig.requestMatchers(HttpMethod.GET, "/allUsers").hasAnyAuthority("ADMIN");
                    authConfig.requestMatchers(HttpMethod.GET, "/createPurse").hasAnyAuthority("USER");
                    authConfig.requestMatchers(HttpMethod.GET, "/deletePurse").hasAnyAuthority("USER");
                    authConfig.requestMatchers(HttpMethod.GET, "/updatePurse").hasAnyAuthority("USER");
                    authConfig.requestMatchers(HttpMethod.GET, "/allPurses").hasAnyAuthority("USER");
                    authConfig.requestMatchers(HttpMethod.GET, "/roles").hasAnyAuthority("ADMIN");
